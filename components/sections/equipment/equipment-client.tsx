...
export default function EquipmentClient({ data }: EquipmentClientProps) {
  // Map the flat data object to the array structure expected by the UI
  // We filter out any items that don't have values in the CMS
  const equipmentList = [
    {
      category: "Microphone",
        ...
        >
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 ${
              equipmentList.length > 2 ? "lg:grid-cols-4" : "lg:grid-cols-2"
